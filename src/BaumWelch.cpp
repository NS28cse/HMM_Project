...
*/
int	maxlen[MAXSAMPLE];		/* ?øΩT?øΩ?øΩ?øΩv?øΩ?øΩ?øΩt?øΩ@?øΩC?øΩ?øΩ?øΩ?øΩ?øΩ∆ÇÃíÔøΩ?øΩ?øΩ?øΩ?øΩ?øΩi?øΩ[ */
double	a[MAXSTATE][MAXSTATE];
double	na[MAXSTATE][MAXSTATE];		/* a?øΩÃçX?øΩV?øΩp */
double	b[MAXSTATE][MAXSYMBOL];
double	nb[MAXSTATE][MAXSYMBOL];	/* b?øΩÃçX?øΩV?øΩp */
double	pi[MAXSTATE];
double	npi[MAXSTATE];				/* pi?øΩÃçX?øΩV?øΩp */
